...
<div class="container" style="margin-bottom: 30px;overflow: hidden">
          <nav class="navbar  fixed-top navbar-expand-lg navbar-light" style="background-color: red   ">
              <i class="fa fa-spinner fa-pulse fa-3x fa-fw text-light"></i>
             <span class="sr-only">Loading...</span>  
             <a class="fa-3x " href="#" style="color:white;">&nbsp;&nbsp;<b style="text-align: center">WELCOME TO VIRTUAL ELECTION BOOTH</b></a>
